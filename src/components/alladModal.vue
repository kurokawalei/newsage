  ...
  <div id="productModal"
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
        ...
        <div :class="isNew ? 'bg-primary' : 'bg-warning'"
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                />
                <div>
                  <img :src="tempProduct.homeFront" class="img-fluid mb-3" />
                </div>

                <button
                  class="btn btn-outline-danger btn-sm d-block w-100"
                  v-if="tempProduct.homeFront"
                  @click="tempProduct.homeFront = ''">刪除檔案</button>
            ...
            <div class="col-sm-8">
              ...
              <div class="mb-3">
                <div class="form-floating">
                  ...
                  ></textarea>
                  <label for="description" class="form-label">簡短敘述文</label>
                </div>
              </div>
              <div class="mb-3">
...
export default {
  ...
  methods: {
    updateProduct() {
      let url = "https://api.news-age.tw/homeBn";
      let http = "post";
      if (!this.isNew) {
        url = `https://api.news-age.tw/homeBn/${this.tempProduct.id}`;
        http = "put";
        console.log("put", url);
        ...
        img.onload = () => {
          ...
          if (this.imageLoaded) {
            ...
            this.$http
              ...
              .then((res) => {
                this.tempProduct.homeFront = res.data;
